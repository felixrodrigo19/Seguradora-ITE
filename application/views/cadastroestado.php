		...
		<body>
						...
						<div class="header-top d-flex justify-content-between align-items-center">
							...
							<div class="main-menubar d-flex align-items-center">
								<nav class="hide">
									...
									<a href="http://localhost/eng3/index.php/estado">Cadastros</a>
			...
			<section class="feature-area section-gap" id="service">
				<div class="container">
					<div class="row">
						<?php
							require $pagina; //estado/index.php
						?>
					</div>
				</div>
			</section>
								...
								<div class="content">
								    <a href="#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url('assets/img/c1.jpg');?>" alt="">
						...
						<div class="col-lg-3 col-md-3 vol-wrap">
							<div class="single-con">
								<div class="content">
								    <a href="#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url('assets/img/c2.jpg');?>" alt="">
								      	<div class="content-details fadeIn-bottom">
								      		<h4>Andy Florence</h4>
								      		<p>
								      			inappropriate behavior
						...
						<div class="col-lg-3 col-md-3 vol-wrap">
							<div class="single-con">
								<div class="content">
								    <a href="#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url('assets/img/c3.jpg');?>" alt="">
								      	<div class="content-details fadeIn-bottom">
								      		<h4>Andy Florence</h4>
								      		<p>
								      			inappropriate behavior
						...
						<div class="col-lg-3 col-md-3 vol-wrap">
							<div class="single-con">
								<div class="content">
								    <a href="#" target="_blank">
								      <div class="content-overlay"></div>
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url('assets/img/c4.jpg');?>" alt="">
								      	<div class="content-details fadeIn-bottom">
								      		<h4>Andy Florence</h4>
								      		<p>
								      			inappropriate behavior
				...
				<div class="container">
					...
					<div class="row">
						<div class="single-blog col-lg-4 col-md-4">
							...
							<img class="f-img img-fluid mx-auto" src="<?php echo base_url('assets/img/b1.jpg');?>" alt="">
							<h4>
						...
						<div class="single-blog col-lg-4 col-md-4">
							<img class="f-img img-fluid mx-auto" src="<?php echo base_url('assets/img/b2.jpg');?>" alt="">
							<h4>
						...
						<div class="single-blog col-lg-4 col-md-4">
							<img class="f-img img-fluid mx-auto" src="<?php echo base_url('assets/img/b3.jpg');?>" alt="">
							<h4>
								<a href="#">Summer ware are coming</a>
							</h4>
							<p>
